...
# A class that test the table generator.
class TableGeneratorTest < Minitest::Test

  # Starts all initial requeriments to run the tests.
  def setup
    @headerEmpty = []
    @dataEmpty = []
  ...
  # Tests the HTML table generator.
  ...
  # Tests the ASCII table generator.

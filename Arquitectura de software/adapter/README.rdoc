...
The <b>adapter pattern</b> can communicate two mismatching
interfaces. The main objective of adapter is cross the chasm
between the interface that we could have and the interface
that we could need.

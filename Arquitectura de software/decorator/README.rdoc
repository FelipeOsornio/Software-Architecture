...
The <b>decorator pattern</b> allows you to easily add an enhancement to an
existing objects. It allows you to layer features atop one another. It's
possible construct objects with the right set of capabilities that you
